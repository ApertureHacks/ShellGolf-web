...
/*
 * files: files contained in the directory
 * subdirs: subdirectories in the directory
 */
 ...
 * start: DirSchema describing the starting state of the file system
 * end: DirSchema describing the end state of the file system
 */
...
exports.Dir = mongoose.model('Dir', DirSchema);
